...
def process_multhiertt_data_batch(input_file, output_file, model_path, log_file, max_tokens=2048, 
    ...
    predictions = {result.get("uid", ""): result.get("extracted_answer", "") for result in results}
...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Process MultiHierTT dataset with VLLM batch inference')
