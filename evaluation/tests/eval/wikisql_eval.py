            ...
            for op_idx, op in enumerate(cond_ops):
                ...
                if match:
                    ...
                    if col_idx >= 0:
                        ...
                        print(f"Warning: Could not match column name '{col_name}' to header list: {columns}")
        ...
        with open(test_data_file, 'r', encoding='utf-8') as f:
            ...
            for line in f:
                ...
                try:
                    ...
                    print(f"Warning: JSON parsing error at line {line_num}, skipped: {str(e)}")
        
        print(f"Successfully loaded headers for {len(headers_by_question)} questions from test data file")
    ...
    try:
        ...
        if test_data_file:
            ...
            if not headers_by_question:
                print(f"Warning: Failed to load header information from test data file, will use default headers")
